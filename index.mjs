...
export { version, versionInfo } from './version.d.ts'; // The primary entry point into fulfilling a GraphQL request.

export { graphql, graphqlSync } from './graphql.d.ts'; // Create and operate on GraphQL type definitions and schema.
